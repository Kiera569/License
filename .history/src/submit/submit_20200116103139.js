...
export default class Submit extends React.Component {
  ...
  // 查看
  show(value) {
    this.setState({ visible: true, isAdd: false, modalTitle: "查看" });
  }
  ...
  render() {
    const columns = [
      ...
      },
      {
        ...
        render: (text, record) => (
          <span>
            <a onClick={() => this.show(record)}>查看</a>
    ...
    return (
      <Layout>
        ...
        >
          <Form {...this.formItemLayout} labelAlign="left" onSubmit={this.handleSubmit}>
