    ...
    const data = [
      {
        ...
        description: "1111111",
        licenseCheck: "xxxxx",
        expiryTime: "2020-01-17 10:10:07",
        issuedTime: "2020-01-14 12:10:07"
      },
      {
        consumerAmount: "2",
        ...
        expiryTime: "2020-01-17 10:10:07",
        issuedTime: "2020-01-12 11:10:07"
      }
    ];
          ...
          >
            ...
            <Form.Item label="证书生效时间">
              {getFieldDecorator("issuedTime", {
                ...
                initialValue: inputValue.issuedTime
            ...
            <Form.Item label="证书失效时间">
              {getFieldDecorator("expiryTime", {
                ...
                initialValue: inputValue.expiryTime
              })(<DatePicker format={dateFormat} />)}
            </Form.Item>
          </Form>
        </Modal>
