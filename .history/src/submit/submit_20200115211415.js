...
export default class Submit extends React.Component {
  ...
  render() {
    ...
    const Add = props => {
      return (
        <Button key="submit" type="primary" onClick={this.handleAdd.bind(this)}>
          Submit
        </Button>
      );
    };
    const Edit = props => {
      return (
        <div>
          <Button type="primary" onClick={this.handleCancle.bind(this)}>
            取消
          </Button>
          <Button type="primary" onClick={this.handleEdit.bind(thsi)}>
            确定
          </Button>
        </div>
      );
